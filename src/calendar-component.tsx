...
class Combo extends SampleBase<{}, {}> {
  ...
  public onfocusIn(args: any) {
    // this.calendarInstance.focusIn();
  }

  public onBlur(args: any) {
    // this.calendarInstance.focusOut();
  }

  public GetPesistData(args: any) {
    console.log(this.calendarInstance.getPersistData());
  }

  public GetView(args: any) {
    console.log(this.calendarInstance.currentView());
  }
    ...
    return (
      ...
      <div className='content-wrapper'>
          <div className='contents'>
            ...
            <CalendarComponent id='calendar' ref={ele => this.calendarInstance = ele!} ></CalendarComponent>
          </div>
        </div>
